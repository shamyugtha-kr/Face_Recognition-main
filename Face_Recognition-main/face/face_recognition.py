...
class Face_Recognition:
    def __init__ (self,root):
        ...
        img_top=Image.open(r"C:\Users\91875\Pictures\Face Project\face detect3.jpeg")
        img_top=img_top.resize((765,700),Image.BICUBIC)
        self.photoimg_top=ImageTk.PhotoImage(img_top)

        f_lbl=Label(self.root,image=self.photoimg_top)
        f_lbl.place(x=0,y=55,width=765,height=700)

        img_bottom=Image.open(r"C:\Users\91875\Pictures\Face Project\FACE2.jpeg")
        img_bottom=img_bottom.resize((800,700),Image.BICUBIC)
    ...
    def face_recog(self):
        ...
        faceCascade=cv2.CascadeClassifier(r"C:\Users\91875\Desktop\py project\haarcascade_frontalface_default.xml")
