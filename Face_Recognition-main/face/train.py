...
class Train:
    def __init__ (self,root):
        ...
        img_top=Image.open(r"C:\Users\91875\Pictures\Face Project\Training.jpg")
        img_top=img_top.resize((1530,525),Image.BICUBIC)
        self.photoimg_top=ImageTk.PhotoImage(img_top)

        f_lbl=Label(self.root,image=self.photoimg_top)
        f_lbl.place(x=0,y=55,width=1530,height=325)

        img_bottom=Image.open(r"C:\Users\91875\Pictures\Face Project\Training.jpg")
        img_bottom=img_bottom.resize((765,525),Image.BICUBIC)
        self.photoimg_bottom=ImageTk.PhotoImage(img_bottom)

        b_lbl=Label(self.root,image=self.photoimg_bottom)
        b_lbl.place(x=0,y=440,width=765,height=325)

        img_bottomr=Image.open(r"C:\Users\91875\Pictures\Face Project\Training.jpg")
        img_bottomr=img_bottomr.resize((765,525),Image.BICUBIC)
