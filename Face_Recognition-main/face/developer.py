...
class Developer:
    def __init__ (self,root):
        ...
        img_top=Image.open(r"C:\Users\91875\Pictures\Face Project\developer.jpg")
        ...
        img_dev=Image.open(r"C:\Users\91875\Pictures\Face Project\developer.jpg")
        img_dev=img_dev.resize((200,200),Image.BICUBIC)
        self.photoimg_dev=ImageTk.PhotoImage(img_dev)

        f_lbl=Label(main_frame,image=self.photoimg_dev)
        f_lbl.place(x=300,y=0,width=200,height=200)

        dev_label=Label(main_frame,text="Hello,My name is SRI",font=("rockwell",12,"bold"), bg="white")
        dev_label.place(x=0,y=5)

        dev_label=Label(main_frame,text="Developer of this project",font=("rockwell",12,"bold"), bg="white")
        dev_label.place(x=0,y=35)

        img1=Image.open(r"C:\Users\91875\Pictures\Face Project\developer.jpg")
